...
let Select = class Select extends (0,_mixins__WEBPACK_IMPORTED_MODULE_4__.Persisted)((0,_mixins__WEBPACK_IMPORTED_MODULE_4__.Focusable)((0,_mixins__WEBPACK_IMPORTED_MODULE_4__.Input)(lit__WEBPACK_IMPORTED_MODULE_0__.LitElement))) {
    constructor() {
        super(...arguments);
    ...
    render() {
        return lit__WEBPACK_IMPORTED_MODULE_0__.html `
            <select ${(0,lit_directives_ref_js__WEBPACK_IMPORTED_MODULE_2__.ref)(this.focusElement)} .disabled=${this.disabled} .value=${this.value || ''} @change=${(ev) => (this.value = ev.target.value)}>
