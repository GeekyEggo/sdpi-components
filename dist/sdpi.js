...
`;var At=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r},Et=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};const kt=t=>{class e extends t{constructor(){super(...arguments),this.disabled=!1,this.inputId=rt()}static get styles(){return[ot(super.styles),Lt,n`
        ...
        `}};Mt=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r}([et("sdpi-button")],Mt);const Nt=t=>null!=t?t:I;class jt{constructor(t,e){this.host=t,this.nodeNames=e,this.items=[],this.host.addController(this),this.observer=new MutationObserver(this.handleMutation.bind(this))}hostConnected(){this.observer.observe(this.host,{childList:!0})}hostDisconnected(){this.observer.disconnect()}handleMutation(t){let e=!1;if(t.forEach((t=>{for(const i of t.addedNodes)this.nodeNames.indexOf(i.nodeName.toLowerCase())>-1&&(e=!0,this.items.push(i));t.removedNodes.forEach((t=>{const i=this.items.indexOf(t);-1!==i&&(e=!0,this.items.splice(i,1))}))})),e){if(this.mutated){const t={preventRequestUpdate:!1};if(this.mutated(t),t.preventRequestUpdate)return}this.host.requestUpdate()}}}class Ot extends jt{constructor(t){super(t,["datalist"])}mutated(t){0===this.items.length?this.dataList=void 0:void 0===this.dataList||this.dataList.id!==this.items[0].id?(this.items[0].id=this.items[0].id||rt(),this.dataList=this.items[0].cloneNode(!0)):t.preventRequestUpdate=!0}}class It{constructor(){this.handlers=[]}dispatch(t){for(const e of this.handlers)e(t)}subscribe(t){this.handlers.push(t)}unsubscribe(t){this.handlers=this.handlers.filter((e=>e!==t))}}class Pt{constructor(){this._promise=new Promise(((t,e)=>{this.resolve=t,this.reject=e}))}get promise(){return this._promise}setResult(t){this.resolve&&this.resolve(t)}setException(t){this.reject&&this.reject(t)}}const Ut=new class{constructor(){this._connection=new Pt,this._connectionInfo=new Pt,this.didReceiveGlobalSettings=new It,this.didReceiveSettings=new It,this.message=new It}async connect(t,e,i,s,n){if(!this._webSocket){const o={actionInfo:n?JSON.parse(n):null,info:JSON.parse(s),propertyInspectorUUID:e,registerEvent:i};o.actionInfo&&this.didReceiveSettings.dispatch(o.actionInfo),this._connectionInfo.setResult(o),this._webSocket=new WebSocket(`ws://localhost:${t}`),this._webSocket.onopen=this.handleOpen.bind(this),this._webSocket.onmessage=this.handleMessage.bind(this)}}getGlobalSettings(){return this.get("getGlobalSettings",(t=>"didReceiveGlobalSettings"===t.event))}setGlobalSettings(t){this.send("setGlobalSettings",t)}getSettings(){return this.get("getSettings",(t=>"didReceiveSettings"===t.event))}setSettings(t){this.send("setSettings",t)}async getConnectionInfo(){return this._connectionInfo.promise}async get(t,e,i){const s=new Pt,n=t=>{e(t)&&(this.message.unsubscribe(n),s.setResult(t))};return this.message.subscribe(n),await this.send(t,i),s.promise}async send(t,e){try{const i=await this._connectionInfo.promise;(await this._connection.promise).send(JSON.stringify({event:t,context:i.propertyInspectorUUID,payload:e,action:i.actionInfo.action}))}catch(e){console.error(`Unable to send request '${t}' as there is no connection.`)}}async handleOpen(){try{const t=await this._connectionInfo.promise;this._webSocket&&(this._webSocket.send(JSON.stringify({event:t.registerEvent,uuid:t.propertyInspectorUUID})),this._connection.setResult(this._webSocket))}catch(t){this._connection.setException(t)}}handleMessage(t){const e=JSON.parse(t.data);switch(e.event){case"didReceiveGlobalSettings":this.didReceiveGlobalSettings.dispatch(e);break;case"didReceiveSettings":this.didReceiveSettings.dispatch(e)}}},Dt=new class{constructor(){Ut.didReceiveGlobalSettings.subscribe((t=>this._globalSettings=t.payload.settings)),Ut.didReceiveSettings.subscribe((t=>this._settings=t.payload.settings)),Ut.getGlobalSettings()}register(t,e,i,s=250){const n=e=>{var s,n;e&&e.payload&&e.payload.settings&&i((s=t,n=e.payload.settings,(Array.isArray(s)?s:s.split(".")).reduce(((t,e)=>t&&t[e]),n)))};return e?Ut.didReceiveGlobalSettings.subscribe(n):Ut.didReceiveSettings.subscribe(n),s?function(i,s){let n;return(i,...o)=>{clearTimeout(n),n=setTimeout((()=>{return s=i,Dt.set(t,e,s);var s}),s,o)}}(0,s):i=>Dt.set(t,e,i)}set(t,e,i){e?(this._globalSettings&&lt(t,this._globalSettings,i),Ut.setGlobalSettings(this._globalSettings)):(this._settings&&lt(t,this._settings,i),Ut.setSettings(this._settings))}},Tt=Dt.register;class zt{constructor(t){(this._host=t).addController(this)}hostConnected(){this._host.setting&&(this._save=Tt(this._host.setting,this._host.isGlobal,(t=>this._host.value=t)))}save(t){this._host.value=t,this._save&&this._save(t)}}var Ht=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r},Zt=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};let Bt=class extends(Rt(_t(kt(X)))){constructor(){super(...arguments),this.store=new zt(this),this.dataListController=new Ot(this),this.type="date"}static get styles(){return[...super.styles,n`
                input {
            ...
            <input
                ${$t(this.focusElement)}
                type=${this.type}
                list=${Nt(null===(t=this.dataListController.dataList)||void 0===t?void 0:t.id)}
                max=${Nt(this.max)}
                min=${Nt(this.min)}
                step=${Nt(this.step)}
                .disabled=${this.disabled}
                .value=${this.value||""}
                @change="${t=>this.store.save(t.target.value)}"
            />
            ${this.dataListController.dataList}
        `}};Ht([st(),Zt("design:type",String)],Bt.prototype,"max",void 0),Ht([st(),Zt("design:type",String)],Bt.prototype,"min",void 0),Ht([st({type:Number}),Zt("design:type",Number)],Bt.prototype,"step",void 0),Ht([st(),Zt("design:type",String)],Bt.prototype,"type",void 0),Bt=Ht([et("sdpi-calendar")],Bt);var Gt=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let Qt=class extends(Rt(_t(at(kt(X))))){constructor(){super(...arguments),this._store=new zt(this)}render(){return this.renderCheckable("checkbox",j`<input
                ${$t(this.focusElement)}
                type="checkbox"
                .checked=${this.value||!1}
                .disabled=${this.disabled}
                @change=${t=>this._store.save(t.target.checked)}
            />`,this.label)}};Gt([st(),function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)}("design:type",String)],Qt.prototype,"label",void 0),Qt=Gt([et("sdpi-checkbox")],Qt);let qt=class extends(xt(Rt(at(kt(X))))){constructor(){super(...arguments),this._childNodes=new jt(this,["option"]),this._store=new zt(this)}render(){return this.renderGrid(this._childNodes.items.map((t=>this.renderCheckable("checkbox",j`<input
                        type="checkbox"
                        .checked=${this.value&&this.value.indexOf(t.value)>-1||!1}
                        .disabled=${this.disabled||t.disabled}
                        .value=${t.value}
                        @change=${this.handleChange}
                    />`,t.text))))}handleChange(t){const e=new Set(this.value);t.target.checked?e.add(t.target.value):e.delete(t.target.value),this._store.save(Array.from(e))}};qt=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r}([et("sdpi-checkbox-list")],qt);let Yt=class extends(Rt(_t(kt(X)))){constructor(){super(...arguments),this._store=new zt(this)}static get styles(){return[...super.styles,n`
                input {
                    background-color: var(--input-bg-color);
                }
            ...
            />
        `}};Yt=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r}([et("sdpi-color")],Yt);class Wt{constructor(t){this.U=t}disconnect(){this.U=void 0}reconnect(t){this.U=t}deref(){return this.U}}class Ft{constructor(){this.Y=void 0,this.q=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.q=t)))}resume(){var t;null===(t=this.q)||void 0===t||t.call(this),this.Y=this.q=void 0}}const Vt=t=>{return!(e=t,null===e||"object"!=typeof e&&"function"!=typeof e||"function"!=typeof t.then);var e},Kt=dt(class extends bt{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CG=new Wt(this),this._$CK=new Ft}render(...t){var e;return null!==(e=t.find((t=>!Vt(t))))&&void 0!==e?e:O}update(t,e){const i=this._$Cyt;let s=i.length;this._$Cyt=e;const n=this._$CG,o=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cwt);t++){const r=e[t];if(!Vt(r))return this._$Cwt=t,r;t<s&&r===i[t]||(this._$Cwt=1073741823,s=0,Promise.resolve(r).then((async t=>{for(;o.get();)await o.get();const e=n.deref();if(void 0!==e){const i=e._$Cyt.indexOf(r);i>-1&&i<e._$Cwt&&(e._$Cwt=i,e.setValue(t))}})))}return O}disconnected(){this._$CG.disconnect(),this._$CK.pause()}reconnected(){this._$CG.reconnect(this),this._$CK.resume()}});async function Jt(){return"windows"==(await Ut.getConnectionInfo()).info.application.platform}var Xt=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r},te=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};let ee=class extends(Rt(_t(kt(X)))){constructor(){super(...arguments),this._store=new zt(this),this.label="..."}static get styles(){return[...super.styles,n`
                .container {
                    align-items: stretch;
                    display: flex;
                }
            ...
            <div class="container">
                <input
                    ...
                    .accept=${this.accept||""}
                    .disabled=${this.disabled}
                    @change="${async t=>this._store.save(await async function(t){const e=decodeURIComponent(t.replace(/^C:\\fakepath\\/,""));return await Jt()?e.replace(new RegExp("/","g"),"\\"):e}(t.target.value))}"
                />
                <label class="value" for="file_input">
                    <span .title=${this.value||""}>${Kt(async function(t){const e=await Jt()?"\\":"/",i=t.split(e);return 1==i.length?t:i[i.length-1]}(this.value||""))}</span>
                </label>
                <label class="button">
        ...
        `}};Xt([st(),te("design:type",String)],ee.prototype,"accept",void 0),Xt([st(),te("design:type",Object)],ee.prototype,"label",void 0),ee=Xt([et("sdpi-file")],ee);var ie=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let se=class extends(Rt(_t(kt(X)))){constructor(){super(...arguments),this._store=new zt(this)}static get styles(){return[...super.styles,Lt,n`
                input {
                    background-color: var(--input-bg-color);
            ...
            />
        `}};ie([st({attribute:"maxlength",type:Number}),function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)}("design:type",Number)],se.prototype,"maxLength",void 0),se=ie([et("sdpi-password")],se);let ne=class extends(xt(Rt(at(kt(X))))){constructor(){super(...arguments),this._childNodes=new jt(this,["option"]),this._store=new zt(this)}render(){return this.renderGrid(this._childNodes.items.map((t=>this.renderCheckable("radio",j`<input
                        type="radio"
                        name="_"
                        ...
                        .value=${t.value}
                        @change=${t=>this._store.save(t.target.value)}
                    />`,t.text))))}};ne=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r}([et("sdpi-radio")],ne);var oe=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r},re=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};let le=class extends(Rt(_t(kt(X)))){constructor(){super(...arguments),this._store=new zt(this),this.showLabels=!1}static get styles(){return[...super.styles,n`
                input {
                    -webkit-appearance: none;
                    margin: 0;
                    height: 22px;
        ...
        />`;return this.showLabels?j`<div class="container">
            ...
            </div>`:i}};oe([st({type:Number}),re("design:type",Number)],le.prototype,"max",void 0),oe([st({type:Number}),re("design:type",Number)],le.prototype,"min",void 0),oe([st({attribute:"showlabels",type:Boolean}),re("design:type",Object)],le.prototype,"showLabels",void 0),oe([st({type:Number}),re("design:type",Number)],le.prototype,"step",void 0),le=oe([et("sdpi-range")],le);var ae=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let ce=class extends X{render(){const t=this.label?j`<label>${this.label}:</label>`:void 0;return j`
            <div class="container grid">
                <div class="label"><label @click=${this.handleLabelClick}>${t}</label></div>
                <div class="content"><slot></slot></div>
            </div>
        `}handleLabelClick(){for(const t of this.querySelectorAll("*")){const e=t;if(e.canFocus)return void e.focus()}}};ce.styles=[Lt,n`
            ::-webkit-scrollbar {
                width: 5px;
            }
        ...
        `],ae([st(),function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)}("design:type",String)],ce.prototype,"label",void 0),ce=ae([et("sdpi-item")],ce);var de=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r};let he=class extends(Rt(_t(kt(X)))){constructor(){super(...arguments),this._childNodes=new jt(this,["optgroup","option"]),this._store=new zt(this)}static get styles(){return[...super.styles,Lt,n`
                select {
                    background-color: var(--input-bg-color);
        ...
        `}renderChildNodes(){if(0===this.childNodes.length)return;const t=e=>e instanceof HTMLOptGroupElement?j`<optgroup .label=${e.label}>${Array.from(e.childNodes).map(t)}</optgroup>`:e instanceof HTMLOptionElement?j`<option .disabled=${e.disabled} .value=${e.text}>${e.label}</option>`:void 0;return j`${this._childNodes.items.map(t)}`}};de([st(),function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)}("design:type",String)],he.prototype,"placeholder",void 0),he=de([et("sdpi-select")],he);var ue=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r},pe=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};let fe=class extends(Rt(_t(kt(X)))){constructor(){super(...arguments),this._store=new zt(this),this.rows=3,this.showLength=!1}static get styles(){return[...super.styles,Lt,n`
                textarea {
                    background-color: var(--input-bg-color);
                    padding: calc(var(--spacer) + 3px) var(--spacer);
                    resize: none;
            ...
            ></textarea>
            ${this.getLengthLabel()}
        `}getLengthLabel(){var t;if(this.showLength||this.maxLength){const e=this.maxLength?j`/${this.maxLength}`:void 0;return j`<label class="length" for=${this.inputId}>${(null===(t=this.value)||void 0===t?void 0:t.length)||0}${e}</label>`}}};ue([st({attribute:"maxlength",type:Number}),pe("design:type",Number)],fe.prototype,"maxLength",void 0),ue([st({type:Number}),pe("design:type",Object)],fe.prototype,"rows",void 0),ue([st({attribute:"showlength",type:Boolean}),pe("design:type",Object)],fe.prototype,"showLength",void 0),fe=ue([et("sdpi-textarea")],fe);var ge=function(t,e,i,s){var n,o=arguments.length,r=o<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(n=t[l])&&(r=(o<3?n(r):o>3?n(e,i,r):n(e,i))||r);return o>3&&r&&Object.defineProperty(e,i,r),r},ve=function(t,e){if("object"==typeof Reflect&&"function"==typeof Reflect.metadata)return Reflect.metadata(t,e)};let be=class extends(Rt(_t(kt(X)))){constructor(){super(...arguments),this._store=new zt(this),this.pattern="",this.placeholder="",this.required=!1}static get styles(){return[...super.styles,Lt,n`
                input {
                    background-color: var(--input-bg-color);
                    padding: calc(var(--spacer) + 3px) var(--spacer);
                }
            ...
            <input
                ...
                @input=${t=>this._store.save(t.target.value)}
            />
        `}};ge([st({attribute:"maxlength",type:Number}),ve("design:type",Number)],be.prototype,"maxLength",void 0),ge([st(),ve("design:type",Object)],be.prototype,"pattern",void 0),ge([st(),ve("design:type",Object)],be.prototype,"placeholder",void 0),ge([st({type:Boolean}),ve("design:type",Object)],be.prototype,"required",void 0),be=ge([et("sdpi-textfield")],be),window.streamDeckClient=Ut;const ye=window.connectElgatoStreamDeckSocket;window.connectElgatoStreamDeckSocket=function(t,e,i,s,n){ye&&ye(t,e,i,s,n),Ut.connect(t,e,i,s,n)};const me=document.createElement("style");me.innerHTML=n`
...
`.cssText,document.head.appendChild(me)})();